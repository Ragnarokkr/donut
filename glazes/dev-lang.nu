...
def get-manifest []: nothing -> record {
    (build-manifest
        ...
        --description 'Development compilers.'
        --scope $SCOPE.linux
        --toppings [
            { name: 'c3c-git' url: 'https://c3-lang.org/' os: $OS.linux package_manager: 'paru' }
            { name: 'clang' url: 'https://clang.llvm.org/' os: $OS.linux package_manager: 'pacman' }
        ]
    )
}
