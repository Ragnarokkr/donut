...
def get-manifest []: nothing -> record {
    ...
    (build-manifest
        ...
        --scope $SCOPE.common
        --toppings [
            { name: 'vivid' url: 'https://github.com/sharkdp/vivid' os: $OS.linux package_manager: 'pacman' }
            { name: 'sharkdp.vivid' url: 'https://github.com/sharkdp/vivid' os: $OS.windows package_manager: 'winget' }
        ]
