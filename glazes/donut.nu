use ../scripts/config.nu [DONUT_DIR SCOPE OS HIGHEST_PRIORITY]
...
def get-manifest []: nothing -> record {
    ...
    (build-manifest
        $ID
        --category 'utility'
        --description 'Dotfiles-Nushell Tracker. Track dotfiles. Glaze Nushell. Customize freely.'
